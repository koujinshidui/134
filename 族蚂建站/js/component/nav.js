    ...
    setting: function (box) {
        ...
        switch (iSelected_show_type) {
            case "General-cross_one":
                ...
                var config1;
                    config1 = [{type:'bannerController',element:iSelected,flag:{className:'.nav.Resize'}},
                        ...
                        {type:'slider',element: iSelected,flag: {title: "文字大小", style: "noTab_noColor",isColor:false, param: "fontSize", size: [12,100]}},
                        ...
                        {type:'slider',element: iSelected,flag: {title: "字间距", style: "noTab_noColor",isColor:false, param: "fontSpace", size: [0,50]}}
                         ];
                ...
                var tabs4 = zmEditor.component.setItems.config(config4);                                                                                                     //{type:'background_opacity',element:iSelected,flag:''}
            ...
            case "General-cross_two":
                ...
                var tabs4= zmEditor.component.setItems.config(config4);                                                                                                   // "shadow", "shadowX", "shadowY", ,{type:'background_opacity',element:iSelected,flag:''}
                // items4.forEach(function (e) {
                //     tabs4.append(e);
                // });
        ...
        // });  items1.forEach(function (e) {
            ...
            case "General-vertical_three_one":
                ...
                var tabs3 = zmEditor.component.setItems.config(config3);                                                                                                     //"shadow", "shadowX", "shadowY",  , {type:'background_opacity',element:iSelected,flag:''}
                // items3.forEach(function (e) {
                //     tabs3.append(e);
                // });
...
zmEditor.globalMethod.nav = {
    ...
    initialize_html_callback: function (_this, iSelected, callback) {
        ...
        v = ulNav.children("div");   // v = ulNav.children("li");
        ...
        if (zmEditor.globalMethod.nav.global_verOrcross(iSelected)) {
            ...
            $(v).each(function (index, ele){
                ...
                u = nav_One_li({
                    text: $(this).children("li").children(".zm-nav-oneLi-div").children(".zm-page-setting-a").text()  // text: $(this).children(".zm-nav-oneLi-div").children(".zm-page-setting-a").text()
                },iSelected, index);
                if(u.length>0)arrPreservation["u"]=u;
                if($(this).children("li").children(".zm-nav-oneLi-div").children(".pageSeteyes").hasClass("fa-eye")) {   //$(this).children(".zm-nav-oneLi-div").children(".pageSeteyes").hasClass("fa-eye")
                    k = $("<span ></span>");
                    ...
                    t = $(this).children("li").children(".zm-dialog-content-pageSet-childulTwo");  //$(this).children(".zm-dialog-content-pageSet-childulTwo");
                    if (t.length > 0) {
                        arrPreservation["t"] = t;
                    }
                    if (t.length > 0) {
                        ...
                        // if (t.children("li").length > 0) {
                            ...
                            // $(t.children("li")).each(function (index, ele) {//二级栏目循环//position: relative;
                                if ($(this).children("li").children(".zm-nav-oneLi-div").children(".pageSeteyes").hasClass("fa-eye")){
                                    o = $("<li class='" + nav_name + "zm-page-setting-liTwo' style=''> <p>" + $(this).children("li").children(".zm-nav-oneLi-div").children(".zm-page-setting-a").text() + "</p></li>");
                                    ...
                                    if (y.length > 0) {
                                        ...
                                        l = zmEditor.globalMethod.nav.typeClass_two_ul_height(arrPreservation.i, y.children("div").length, zmEditor.globalMethod.nav.data.arrLike[nav_name].li.sStyle.height);
                                        ...
                                        var ulThreeHeight=y.children("div").length>4?" ":parseInt(zmEditor.globalMethod.nav.data.arrLike[nav_name].li.sStyle.lineHeight)*4+"px";
                                        ...
                                        if (y.children("div").length > 0) {//三级栏目循环
                                            ...
                                            $(y.children("div")).each(function (index, ele) {
                                                ...
                                                if ($(this).children("li").children(".zm-nav-oneLi-div").children(".pageSeteyes").hasClass("fa-eye")){
                                                    z = $("<li class='" + nav_name + "zm-page-setting-liThree' style=''> <p>" + $(this).children("li").children(".zm-nav-oneLi-div").children(".zm-page-setting-a").text() + "</p></li>");
                        ...
                        if (t.children("div").length > 0) {
                            ...
                            $(t.children("div")).each(function (index, ele) {//二级栏目循环//position: relative;
                                ...
                                if ($(this).children("li").children(".zm-nav-oneLi-div").children(".pageSeteyes").hasClass("fa-eye")){
                                    ...
                                    o = $("<li class='" + nav_name + "zm-page-setting-liTwo' style=''><p>" + $(this).children("li").children(".zm-nav-oneLi-div").children(".zm-page-setting-a").text() + "</p></li>");//width: " + zmEditor.globalMethod.nav.data.arrLike[nav_name].li.sStyle.width + "; background-color:" + zmEditor.globalMethod.nav.data.arrLike[nav_name].li.sStyle.backgroundColor + ";margin-top: " + zmEditor.globalMethod.nav.typeClass_ul_li_two_marginTop(parseInt(u.css("height")), t.children("li").length, l, i) + "
                                    ...
                                    if (y.children("div").length > 0) {//三级栏目循环
                                        ...
                                        $(y.children("div")).each(function (index, ele) {  //";margin-top:"+zmEditor.globalMethod.nav.typeClass_ul_li_two_marginTop(parseInt(u.css("height")),y.children("li").length, l, i)"+
                                            ...
                                            if ($(this).children("li").children(".zm-nav-oneLi-div").children(".pageSeteyes").hasClass("fa-eye")){
                                                ...
                                                z = $("<li class='" + nav_name + "zm-page-setting-liThree' style=''><p>" + $(this).children("li").children(".zm-nav-oneLi-div").children(".zm-page-setting-a").text() + "</p></li>");//三级ul添加三级li  width: " + zmEditor.globalMethod.nav.data.arrLike[nav_name].li.sStyle.width + ";background-color:" + zmEditor.globalMethod.nav.data.arrLike[nav_name].li.sStyle.backgroundColor + ";
